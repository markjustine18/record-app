    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            if (isset($_POST['submit'])) {
                // Get form data
                $documentcode = mysqli_real_escape_string(
                    $conn,
                    $_POST['documentcode']
                );
                ...
                // Create insert query
                $query = "INSERT INTO transaction (documentcode, action, remarks)
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name='employee'>
                                                        ...
                                                        <?php
                                                        $query =
                                                            "SELECT id, CONCAT(lastname, ', ', firstname) as employee_fullname FROM employee";
                                                        $result = mysqli_query(
                                                            $conn,
                                                            $query
                                                        );
                                            ...
                                            <div class="col-md-6 pl-1">
                                                ...
                                                <button type="submit" name="submit" value="Submit"
                                                    class="btn btn-info btn-fill pull-right">Save Profile</button>
